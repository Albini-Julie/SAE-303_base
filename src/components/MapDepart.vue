...
<template>
    <div>
        <div class="">
            <select class="border-2 border-Rose_foncé " v-model="depSelect" @change="selection(depSelect)">
                <option disabled value="0">Choississez un département</option>
